			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - GrowSoft: Your Partner in Business Growth | GrowSoft.in</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - GrowSoft: Your Partner in Business Growth | GrowSoft.in</title>
					</xsl:otherwise>
				</xsl:choose>
